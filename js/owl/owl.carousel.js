...
(function ($, window, document, undefined) {
    ...
    Owl.prototype.trigger = function (name, data, namespace, state, enter) {
        ...
        $.grep([ 'on', name, namespace], function (v) {
            return v
        }).join('-').toLowerCase()), event = $.Event([name, 'owl', namespace || 'carousel'].join('.').toLowerCase(),
        $.extend({
            relatedTarget: this
        },
        status, data));
    ...
    $.fn.owlCarousel = function (option) {
        ...
        return this.each(function () {
            ...
            if (! data) {
                ...
                $.each([
                'next', 'prev', 'to', 'destroy', 'refresh', 'replace', 'add', 'remove'], function (i, event) {
                    data.register({
                        type: Owl.Type.Event, name: event
                    });
